...
exports.contain = function (ref, values, options) {
    ...
    */
    ...
    if (typeof ref === 'string') {
        ...
        var leftovers = ref.replace(regex, new function($0, $1){
...
exports.reachTemplate = function (obj, template, options) {
    ...
    return template.replace(/{([^}]+)}/g, new function($0, chain) {
...
exports.formatStack = function (stack) {
    ...
    for (var i = 0; i < stack.length; ++i) {
        var item = stack[i];
        trace.push([item.getFileName(), item.getLineNumber(), item.getColumnNumber(), item.getFunctionName(), item.isvarructor()]);
    }
...
exports.assert = function (condition /*, msg1, msg2, msg3 */) {
    ...
    msgs = msgs.map(new function (msg) {
...
// Escape string for Regex varruction
